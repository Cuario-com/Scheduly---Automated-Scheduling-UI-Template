...
import 'preview_single_session_model.dart';
export 'preview_single_session_model.dart';

class PreviewSingleSessionWidget extends StatefulWidget {
  const PreviewSingleSessionWidget({
    super.key,
    this.title,
    this.duration,
  });
  ...
  static String routeName = 'previewSingleSession';
  static String routePath = '/previewSingleSession';

  @override
  State<PreviewSingleSessionWidget> createState() =>
      _PreviewSingleSessionWidgetState();
}

class _PreviewSingleSessionWidgetState
    extends State<PreviewSingleSessionWidget> {
  late PreviewSingleSessionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreviewSingleSessionModel());
                            ...
                            Container(
                              ...
                              child: Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.goNamed(
                                      CreateSingleSessionWidget.routeName,
                                      queryParameters: {
